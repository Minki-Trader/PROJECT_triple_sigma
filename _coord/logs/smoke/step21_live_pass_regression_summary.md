# STEP21 Live Pass Regression Artifact Summary

Run date:
- 2026-03-09

Preset:
- `C:\Users\awdse\AppData\Roaming\MetaQuotes\Terminal\D0E8209F77C8CF37AD8BF550E51FF075\MQL5\Experts\PROJECT_triple_sigma\_coord\tester\step21\step21_tester_live_pass_regression.ini`

Validation class:
- `live-pass-regression`

Trigger source:
- `feature-off live early-exit regression gate`
- synthetic: `false`
...
Baseline compare:
- baseline: `_coord/artifacts/step20_live_pass_regression`
- core-row match: `true`
